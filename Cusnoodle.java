...
public class Cusnoodle {
    ...
    private final JComboBox manu;
    private final JButton bk, ad, book;
    private final JRadioButton line1, line2, line3, line4, line5, spc1, spc2;
    private final JCheckBox topping1, topping2, topping3, topping4, topping5, topping6, topping7, topping8, topping9, topping10, egg1;
    ...
    public Cusnoodle(){
        ...
        DCtion2 = new JLabel("กรุณาเลือกชนิดของประเภทก๋วยเตี๋ยว");
        DCtion3 = new JLabel("กรุณาเลือกชนิดของประเภทก๋วยเตี๋ยว");
        DCtion4 = new JLabel("กรุณาเลือกชนิดของประเภทก๋วยเตี๋ยว");
        DCtion5 = new JLabel("กรุณาเลือกชนิดของประเภทก๋วยเตี๋ยว");
        DCtion6 = new JLabel("กรุณาเลือกชนิดของประเภทก๋วยเตี๋ยว");
        manu = new JComboBox();
        ...
        topping1 = new JCheckBox("หมูเด้งดึ๋งๆ");
        topping2 = new JCheckBox("หมูตุ๋นหุง อุ่น ตุ๋น ต้ม นึ่ง");
        topping3 = new JCheckBox("หมูชิ้น ชา");
        topping4 = new JCheckBox("หมูกรุบกรอบ");
        topping5 = new JCheckBox("หมูแดงมาก");
        topping6 = new JCheckBox("เนื้อออสซี่");
        topping7 = new JCheckBox("ไข่ไก่อารมณ์ดี");
        topping8 = new JCheckBox("เกี๊ยวหมูทอด");
        topping9 = new JCheckBox("แคปหมูจากสุพัน");
        topping10 = new JCheckBox("เนื้อฮิปโปทอด");
        egg1 = new JCheckBox("ใส่ไข่ไก่อารมณ์ดี");

        comment = new JTextField();
        big = new JPanel();
        pn1 = new JPanel(); pn2 = new JPanel(); pn3 = new JPanel(); pn4 = new JPanel(); pn5 = new JPanel(); 
        pn6 = new JPanel(); pn7 = new JPanel(); pn8 = new JPanel(); pn9 = new JPanel(); pn10 = new JPanel();
        blank1 = new JPanel(); blank2 = new JPanel(); blank3 = new JPanel(); blank4 = new JPanel(); blank5 = new JPanel();
        blank6 = new JPanel(); blank7 = new JPanel();
        pnDCtion1 = new JPanel(); pnDCtion2 = new JPanel(); pnDCtion3 = new JPanel(); pnDCtion4 = new JPanel();
        pnDCtion5 = new JPanel(); pnDCtion6 = new JPanel();
        ...
        pn6.add(topping1); pn6.add(topping2); pn6.add(topping3); pn6.add(topping4); pn6.add(topping5);
        pn6.add(topping6); pn6.add(topping7); pn6.add(topping8); pn6.add(topping9); pn6.add(topping10);
        topping1.setFont(content); topping2.setFont(content); topping3.setFont(content); topping4.setFont(content); topping5.setFont(content);
        topping6.setFont(content); topping7.setFont(content); topping8.setFont(content); topping9.setFont(content); topping10.setFont(content);
        ...
        big.add(pn1); big.add(pn2); big.add(pn3); big.add(pnDCtion1);
       big.add(pn4);  big.add(pnDCtion2); big.add(pn5); big.add(pnDCtion3);
        big.add(pn6); big.add(pnDCtion4); big.add(pn7); big.add(pnDCtion5); big.add(pn8); big.add(pnDCtion6); big.add(pn9); big.add(pn10);
...
//        try {
//            UIManager.setLookAndFeel(new f);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
        new Cusnoodle();
